...
* Команда `exit` завершает работу интерпретатора, а именно в методе execute бросаем исключение `SystemExit`, которое в дальнейшем ловится в `Main`. При существовании субпроцессов отправляем им сигнал прерывания и если они не завершились - убиваем. 
